...
<header class="topbar" data-topbar>
  <div class="topbar__inner">
    <a class="brand" data-cursor="RM" href="<?= url('/') ?>" aria-label="<?= e($site['name']) ?>, home">
      <span class="brand-mark" aria-hidden="true">RM</span>
      <span class="brand-name"><?= e($site['name']) ?></span>
    </a>
    <div class="topbar-controls">
      <button class="ctrl-btn theme-btn" type="button" data-cursor-icon data-theme-toggle aria-label="Switch colour theme">
      ...
      <button class="ctrl-btn menu-btn" type="button" data-cursor-icon="menu" data-menu-trigger aria-haspopup="true" aria-expanded="false" aria-controls="site-menu" aria-label="Open menu">
